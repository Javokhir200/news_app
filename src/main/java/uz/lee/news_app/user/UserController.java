...
public class UserController {
    ...
    public ResponseEntity<?> getFollowersCountByUsername(@RequestParam("username") String username){
        return ResponseEntity.ok("followers= " + userService.countFollowers(username));
    }

    @GetMapping("/get-followings")
    public ResponseEntity<?> getFollowingsCountByUsername(@RequestParam("username") String username){
    ...
    @DeleteMapping
    public ResponseEntity<?> deleteAccount(@RequestParam("password") String password,@RequestParam("username") String username,Principal principal){
        if (checkPermission(username,principal)){
